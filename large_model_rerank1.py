...
# Stage 1: Candidate retrieval using Sentence Transformer/all-distilroberta-v1
...
# Stage 2: Reranking using cross-encoder/ms-marco-MiniLM-L-12-v2
...
def main():
    st.title("Multi-Stage Retrieval Pipeline with Evaluation(Large model)")
